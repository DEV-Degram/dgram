...
# and goes by the name 'dgram (@pydgram)'. Join our group to talk to him!
...
if "dgram_BOT_TOKEN" not in os.environ or "GROUP_CHAT_ID" not in os.environ:
    raise AssertionError("Please configure dgram_BOT_TOKEN and GROUP_CHAT_ID as environment variables")

bot = dgram.Asyncdgram(os.environ["dgram_BOT_TOKEN"])
